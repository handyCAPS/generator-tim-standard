...
module.exports = function(grunt) {
    ...
    Path.js = {
        dev: addSlash(Path.dev , Path.name.js, '<%= appName %>'),
        dist: addSlash(Path.dist , Path.name.js, '<%= appName %>'),
        test: addSlash(Path.dev , Path.name.js , Path.test)
    };

    Path.scss = {
        src: addSlash(Path.dev, Path.name.scss, '<%= appName %>'),
        dev: addSlash(Path.dev, Path.name.css, '<%= appName %>'),
        dist: addSlash(Path.dist, Path.name.css, '<%= appName %>')
    };
